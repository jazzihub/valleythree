...
//im Gegensatz zu @Statefull kann ein stateless Klasse keine Informationen speichern
...
public class Service
{
	...
	public List<Event> getAllEvents()
	{
		try
		{
			Query query = entityManager.createNamedQuery(Event.NQ_FIND_ALL, Event.class);
	...
	public List<Event> getEventByBegin(Date begin)
	{
		try
		{
			TypedQuery<Event> query = entityManager.createNamedQuery(Event.NQ_GET_EVENT_BY_BEGIN,Event.class);
	...
	public List<Event> getEventByBeginAndEnd(Date begin, Date end)
	{
		try
		{
			TypedQuery<Event> query = entityManager.createNamedQuery(Event.NQ_GET_EVENT_BY_BEGIN_END,Event.class);
			query.setParameter("begin", begin);
	...
	public List<Event> getEventFromNow()
	{
		try
		{
			TypedQuery<Event> query = entityManager.createNamedQuery(Event.NQ_GET_EVENT_FROM_NOW,Event.class);
			return query.getResultList();
		} catch (Throwable t)
		{
	...
	public List<Event> getEventByKind(String kind)
	{
		try
		{
			TypedQuery<Event> query = entityManager.createNamedQuery(Event.NQ_GET_EVENT_BY_KIND,Event.class);
	...
	public List<Event> getEventByPlace(String place)
	{
		try
		{
			TypedQuery<Event> query = entityManager.createNamedQuery(Event.NQ_GET_EVENT_BY_PLACE,Event.class);
	...
	public void addEvent(Event e)
	{
		...
		{
			logger.error("Fehler Service.addEvent: Event konnte nicht hinzugefügt werden", t);
		}
	}
	...
	public List<Visitor> getAllVisitors()
	{
		try
		{
			TypedQuery<Visitor> query = entityManager.createNamedQuery(Visitor.NQ_FIND_ALL, Visitor.class);
			return query.getResultList();
		} catch (Throwable t)
		{
	...
	public List<Visitor> getUsersByLastAndFirstname(String lastname, String firstname)
	{
		try
		{
			TypedQuery<Visitor> query = entityManager.createNamedQuery(
